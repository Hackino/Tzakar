...
import com.adrianwitaszak.kmmpermissions.permissions.delegate.PostNotificationPermissionDelegate
...
//    }
    ...
    single<PermissionDelegate>(named(Permission.POST_NOTIFICATION.name)) {
        PostNotificationPermissionDelegate(
            context = get(),
            activity = inject(),
        )
    }
